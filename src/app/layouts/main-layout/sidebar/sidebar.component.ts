...
export class SidebarComponent {
  ...
  navItems = [
    ...
    { label: 'Acreditaciones', route: '/panel/acreditaciones', roles: ['organizador', 'admin', 'staff'], badge: '', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>' },
    ...
    { label: 'Mensajes', route: '/panel/mensajes', roles: ['organizador', 'admin', 'staff'], badge: '', icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>' },
