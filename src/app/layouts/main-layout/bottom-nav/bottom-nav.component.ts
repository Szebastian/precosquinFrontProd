...
export class AdminBottomNavComponent implements OnInit, OnDestroy {
  ...
  moreItems = computed(() => {
    ...
    const allItems = [
      ...
      { label: 'Reportes', route: '/panel/reportes', roles: ['organizador', 'admin', 'sede'], icon: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="m19 9-5 5-4-4-3 3"/></svg>' },
