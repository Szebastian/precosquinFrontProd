...
@Component({
  ...
  styles: [`
    ...
    :host ::ng-deep .separator-groups { display: flex; flex-direction: column; gap: var(--space-5); align-items: center; }
    :host ::ng-deep .separator-group { display: flex; flex-direction: column; align-items: center; gap: var(--space-3); }
    :host ::ng-deep .separator-group-label { font-size: 11px; font-weight: var(--weight-bold); letter-spacing: 0.15em; text-transform: uppercase; color: rgba(255,255,255,0.55); }
    ...
    @media (max-width: 1024px) { :host ::ng-deep .separator-title { font-size: 1.5rem; } :host ::ng-deep .separator-cats { gap: var(--space-2); } :host ::ng-deep .separator-groups { gap: var(--space-4); } :host ::ng-deep .sep-cat { font-size: 11px; padding: 4px 10px; } :host ::ng-deep .separator-stats { gap: var(--space-5); } :host ::ng-deep .sep-stat-value { font-size: 2rem; } }
    @media (max-width: 640px) {
      ...
      :host ::ng-deep .separator-groups { gap: var(--space-3); }
