    ...
    <div class="page-container">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Estadisticas y reportes del evento</p>
        </div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="empty-state">
            ...
            <h3 class="empty-title">Centro de reportes</h3>
            <p class="empty-desc">Aca se generan reportes de inscripciones, engagement y exportacion de datos.</p>
          </div>
        </div>
      </div>
    </div>
