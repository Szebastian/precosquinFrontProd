    ...
    <div class="page-container">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Calendario de eventos y presentaciones</p>
        </div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="empty-state">
            ...
            <h3 class="empty-title">Calendario de eventos</h3>
            <p class="empty-desc">Aca se organizara el cronograma de presentaciones, soundchecks y ensayos.</p>
          </div>
        </div>
      </div>
    </div>
...
export class CronogramaPageComponent {}
