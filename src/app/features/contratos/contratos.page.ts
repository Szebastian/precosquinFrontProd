    ...
    <div class="page-container">
      <div class="page-header">
        <div>
          ...
          <p class="page-subtitle">Gestion y firma digital de contratos</p>
        </div>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="empty-state">
            ...
            <h3 class="empty-title">Gestion de contratos</h3>
            <p class="empty-desc">Aca se envian, monitorean y firman los contratos de participacion.</p>
          </div>
        </div>
      </div>
    </div>
